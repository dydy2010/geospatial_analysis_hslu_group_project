...
output_file: "GEO_Project_Short.pdf"
output:
  pdf_document:
    toc: false
    toc_depth: 2
...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = "GEO_Project_Short.pdf") })
---
...
### Traffic Growth: 2013 (Baseline) and 2025 (Current)
```{r traffic-selected, echo=FALSE, fig.show="hold", out.width="48%"}
...
*See Appendix A for complete year-by-year traffic growth maps (2013-2025).*
...
### Population Growth: 2013 (Baseline) and 2025 (Current)
```{r population-selected, echo=FALSE, fig.show="hold", out.width="48%"}
...
*See Appendix A for complete year-by-year population growth maps (2013-2025).*
...
### Stress Index: 2016 (Spike Year) and 2025 (Current)
```{r stress-selected, echo=FALSE, fig.show="hold", out.width="48%"}
...
*See Appendix A for complete year-by-year stress index maps (2013-2025).*
